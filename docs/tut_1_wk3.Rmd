...
- Northside and Southside order shelving from the same two manufacturers, Arnold Manufacturers and Supershelf, Inc. 
- Demands by the users are 50 for Zrox, 60 for Hewes, and 40 for Rockrite. 
...
**Find the transportation plan that minimises the costs**
